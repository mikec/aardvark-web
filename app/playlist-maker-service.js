aardvarkweb.PlaylistMaker = function() {
    ...
    this.setSongLimit = function(_songLimit) {
        songLimit = _songLimit;
    };

    this.$get = ['$rootScope', 'Rdio', function($rootScope, Rdio) {
        ...
        PlaylistMaker.prototype.getPlaylist = function(artistKeys) {
            ...
            Rdio.getArtists(artistKeys)
                    .then(function(artists) {
                        ...
                        if(songLimit) {
                            stationKeys = stationKeys.slice(0, songLimit);
                        }
...
aardvarkweb.provider('PlaylistMaker', aardvarkweb.PlaylistMaker);